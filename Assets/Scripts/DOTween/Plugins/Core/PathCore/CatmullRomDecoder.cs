...
namespace DG.Tweening.Plugins.Core.PathCore
{
	...
	{
		// Token: 0x06000217 RID: 535 RVA: 0x0000C100 File Offset: 0x0000A300
		...
		// Token: 0x06000218 RID: 536 RVA: 0x0000C1F0 File Offset: 0x0000A3F0
		internal override Vector3 GetPoint(float perc, Vector3[] wps, Path p, ControlPoint[] controlPoints)
		{
			...
			float d = 0.5f;
			Vector3 a3 = -a + 3f * a2 - 3f * vector + b;
			float num5 = num4;
			Vector3 a4 = a3 * (num5 * num5 * num4);
			Vector3 a5 = 2f * a - 5f * a2 + 4f * vector - b;
			float num6 = num4;
			return d * (a4 + a5 * (num6 * num6) + (-a + vector) * num4 + 2f * a2);
		}

		// Token: 0x06000219 RID: 537 RVA: 0x0000C328 File Offset: 0x0000A528
		...
		// Token: 0x0600021A RID: 538 RVA: 0x0000C3D0 File Offset: 0x0000A5D0
